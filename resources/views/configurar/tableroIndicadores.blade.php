                            ...
                            <table class="table" style="font-size: 10px">
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            <td class=""><a
                                                    href="{{ URL::to('historialMeses') }}/{{ $item->idIndicador }}/{{ $item->idTablero }}">{{ $item->codigo }}</a>
                                            </td>
                                            ...
                                            <td>
                                                @if (auth()->user()->id == $item->responsable)
                                                    <a
                                                        href="{{ URL::to('listarMetaFutura') }}/{{ $item->idIndicador }}/{{ $item->idTablero }}">{{ $item->responsable()->first()->name }}</a>
                                                @else
                                            ...
                                            @if (auth()->user()->id == $item->responsable ||auth()->user()->id == 1 )
                                                @if ($item->colores == 'V')
                                                    <td class="text-center" style="background: #03ca49">
                                                        <a href="{{ URL::to('correctivas') }}/{{ $tipo }}"
