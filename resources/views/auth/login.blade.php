        ...
        <div class="container">
            <div class="col-lg-4 col-md-6 ml-auto mr-auto">
                <form class="form" method="POST" action="{{ route('login') }}">
                    @csrf
                    <div class="card card-login" style="  background-color: rgb(237 223 223 / 68%);">
                        <marquee> <strong>
                                <font face="Arial" size="2" color="White">!.. Indicador Cerrado ..!</font>
                            </strong> </marquee>
                        <div class="card-header ">
                            <div class="card-header text-center">
                                {{--  <h3 class="header text-center">{{ __('Login') }}</h3> --}}
                                <img src="{{ asset('paper') }}/img/bg/sello.png" width="50%">
                            </div>
                        </div>
                        <div class="card-body ">
